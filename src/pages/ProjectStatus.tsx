              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <select required className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl p-3 outline-none focus:border-green-500/50 text-white" value={formData.head_id} onChange={e => setFormData({...formData, head_id: e.target.value})}>
